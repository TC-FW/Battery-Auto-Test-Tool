...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.rule_table = QtWidgets.QTableWidget(Form)
        self.rule_table.setLineWidth(1)
        self.rule_table.setRowCount(0)
        self.rule_table.setObjectName("rule_table")
        self.rule_table.setColumnCount(13)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.rule_table.setHorizontalHeaderItem(11, item)
        item = QtWidgets.QTableWidgetItem()
        self.rule_table.setHorizontalHeaderItem(12, item)
        self.rule_table.horizontalHeader().setVisible(True)
        self.rule_table.horizontalHeader().setCascadingSectionResizes(True)
        self.rule_table.horizontalHeader().setDefaultSectionSize(70)
        self.rule_table.horizontalHeader().setHighlightSections(True)
        self.rule_table.horizontalHeader().setMinimumSectionSize(70)
        ...
        self.gridLayout.addWidget(self.group_cycle_count_input, 4, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.enter_button, 5, 5, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        item = self.rule_table.horizontalHeaderItem(11)
        item.setText(_translate("Form", "Mode / V"))
        item = self.rule_table.horizontalHeaderItem(12)
