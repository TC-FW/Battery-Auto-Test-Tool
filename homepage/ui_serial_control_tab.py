...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.dc_enable_checkbox = QtWidgets.QCheckBox(Form)
        self.dc_enable_checkbox.setObjectName("dc_enable_checkbox")
        self.gridLayout.addWidget(self.dc_enable_checkbox, 1, 7, 1, 1)
        ...
        self.eload_enable_checkbox = QtWidgets.QCheckBox(Form)
        self.eload_enable_checkbox.setObjectName("eload_enable_checkbox")
        self.gridLayout.addWidget(self.eload_enable_checkbox, 2, 7, 1, 1)
        self.label_4 = QtWidgets.QLabel(Form)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 1, 1, 1, 1)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.serial_connect_button = QtWidgets.QPushButton(Form)
        self.serial_connect_button.setObjectName("serial_connect_button")
        self.horizontalLayout_2.addWidget(self.serial_connect_button)
        self.serial_disconnect_button = QtWidgets.QPushButton(Form)
        self.serial_disconnect_button.setObjectName("serial_disconnect_button")
        self.horizontalLayout_2.addWidget(self.serial_disconnect_button)
        self.gridLayout.addLayout(self.horizontalLayout_2, 4, 6, 1, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.dc_enable_checkbox.setText(_translate("Form", "启用"))
        ...
        self.eload_enable_checkbox.setText(_translate("Form", "启用"))
        self.label_4.setText(_translate("Form", "<html><head/><body><p align=\"center\">型号</p></body></html>"))
        self.serial_connect_button.setText(_translate("Form", "连接串口"))
        self.serial_disconnect_button.setText(_translate("Form", "断开连接"))
