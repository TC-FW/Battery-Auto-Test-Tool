...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.test_status_table.setColumnCount(3)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.test_status_table.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.test_status_table.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.test_status_table.setItem(0, 2, item)
    ...
    def retranslateUi(self, Form):
        ...
        item = self.test_status_table.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Judge"))
        item = self.test_status_table.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Status"))
        __sortingEnabled = self.test_status_table.isSortingEnabled()
        self.test_status_table.setSortingEnabled(False)
        self.test_status_table.setSortingEnabled(__sortingEnabled)
